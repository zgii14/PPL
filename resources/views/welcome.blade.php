...
<html lang="en">
    ...
    <body>
            ...
            <div class="container-lg position-relative px-lg-3 p-0" style="z-index: 9;">
                <nav class="navbar navbar-expand-lg navbar-light py-lg-0 pl-lg-5 bg-white py-3 pl-3">
                    <a href="" class="navbar-brand">
                        <h1 class="text-secondary m-0"><span class="text-primary">DRY</span>ME</h1>
                    </a>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                ...
                                <h1 class="display-3 mb-md-4 text-white">Best For Laundry Services</h1>
                    ...
                    <div class="carousel-item">
                        ...
                        <div class="carousel-caption d-flex flex-column align-items-center justify-content-center">
                            <div class="p-3" style="max-width: 900px;">
                                <h4 class="text-uppercase mb-md-3 text-white">Laundry & Dry Cleaning</h4>
                                <h1 class="display-3 mb-md-4 text-white">Highly Professional Staff</h1>
                                <a href="" class="btn btn-primary py-md-3 px-md-5 mt-2">Learn More</a>
                            </div>
                        </div>
                    </div>
        ...
        <!-- Contact Info Start -->
        <div class="container-fluid contact-info mb-4 mt-5">
                ...
                <div class="row">
                    <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-lg-0 mb-4"
                        ...
                        <div class="d-inline-flex">
                            ...
                            <div class="d-flex flex-column">
                                <h5 class="font-weight-medium text-white">Our Location</h5>
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center bg-primary mb-lg-0 mb-4"
                        ...
                        <div class="d-inline-flex text-left">
                            ...
                            <div class="d-flex flex-column">
                                <h5 class="font-weight-medium text-white">Email Us</h5>
                    ...
                    <div class="col-md-4 d-flex align-items-center justify-content-center bg-secondary mb-lg-0 mb-4"
                        ...
                        <div class="d-inline-flex text-left">
                            ...
                            <div class="d-flex flex-column">
                                <h5 class="font-weight-medium text-white">Call Us</h5>
            ...
            <div class="pt-lg-4 container pt-0">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-7 mt-lg-0 pl-lg-5 mt-5">
                        ...
                        <h5 class="font-weight-medium font-italic mb-4">Clita sit et ipsum sed. Volup duo sea dolor
                            rebum ea rebum kasd stet. Dolor at duo dolor sit stet.</h5>
                        <p class="mb-2">Invidunt lorem justo sanctus clita. Erat lorem labore ea, justo dolor lorem
                            ipsum ut sed eos, ipsum et dolor kasd sit ea justo. Erat justo sed sed diam. Ea et erat ut
        ...
        <div class="container-fluid pb-3 pt-5">
            <div class="container">
                <h6 class="text-secondary text-uppercase font-weight-medium mb-3 text-center">Our Services</h6>
                <h1 class="display-4 mb-5 text-center">What We Offer</h1>
                <div class="row">
                    <div class="col-lg-3 col-md-6 pb-1">
                        <div class="d-flex flex-column align-items-center justify-content-center bg-light mb-4 px-4 text-center"
                            style="height: 300px;">
                            <div class="d-inline-flex align-items-center justify-content-center rounded-circle mb-4 bg-white shadow"
        ...
        <div class="container-fluid pt-5">
            <div class="container">
                <h6 class="text-secondary text-uppercase font-weight-medium mb-3 text-center">Working Process</h6>
                <h1 class="display-4 mb-5 text-center">How We Work</h1>
                <div class="row">
        ...
        <div class="container-fluid pb-3 pt-5">
            <div class="container">
                <h6 class="text-secondary text-uppercase font-weight-medium mb-3 text-center">Our Pricing Plan</h6>
                <h1 class="display-4 mb-5 text-center">The Best Price</h1>
                <div class="row">
                    <div class="col-lg-4 mb-4">
                        <div class="bg-light mb-2 pt-4 text-center">
                            <div class="d-inline-flex flex-column align-items-center justify-content-center bg-secondary rounded-circle mb-4 mt-2 shadow"
                            ...
                            <a href="" class="btn btn-secondary px-4 py-2">Signup Now</a>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="bg-light mb-2 pt-4 text-center">
                            <div class="d-inline-flex flex-column align-items-center justify-content-center bg-primary rounded-circle mb-4 mt-2 shadow"
                                style="width: 200px; height: 200px; border: 15px solid #ffffff;">
                            ...
                            <a href="" class="btn btn-primary px-4 py-2">Signup Now</a>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-4">
                        <div class="bg-light mb-2 pt-4 text-center">
        ...
        <div class="container-fluid mt-5 pb-2">
            <div class="container">
                <h6 class="text-secondary text-uppercase font-weight-medium mb-3 text-center">Our Blog</h6>
                <h1 class="display-4 mb-5 text-center">Latest From Blog</h1>
                <div class="row">
                        ...
                        <div class="mb-4 shadow">
                            <div class="position-relative">
                                ...
                                <a href=""
                                    ...
                                    <h4 class="font-weight-medium mb-3 text-center text-white">Dolor site amet clita
                                        kasd sanct ipsum</h4>
                            ...
                            <p class="m-0 p-4">Amet dolores labore magna et amet tempor dolor et dolor. Et sit ipsum et
                                eos rebum labore ea labore sea. Et sed elitr labore sed labore. Lorem et lorem amet sed
                                sed kasd ipsum rebum</p>
                        </div>
                    </div>
                    <div class="col-lg-4 mb-2">
                        <div class="mb-4 shadow">
        ...
        <div class="container-fluid bg-primary px-sm-3 px-md-5 mt-5 pt-5 text-white">
            <div class="row pt-5">
                <div class="col-lg-3 col-md-6 mb-5">
                    ...
                    <p>Volup amet magna clita tempor. Tempor sea eos vero ipsum. Lorem lorem sit sed elitr sit no, sed
                        kasd et ipsum dolor duo dolor</p>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="mb-2 text-white" href="#"><i class="fa fa-angle-right mr-2"></i>Home</a>
                        <a class="mb-2 text-white" href="#"><i class="fa fa-angle-right mr-2"></i>About Us</a>
                        <a class="mb-2 text-white" href="#"><i class="fa fa-angle-right mr-2"></i>Services</a>
                        <a class="mb-2 text-white" href="#"><i class="fa fa-angle-right mr-2"></i>Pricing</a>
                ...
                <div class="col-lg-3 col-md-6 mb-5">
                    ...
                    <form action="">
                        ...
                        <div>
                            <button class="btn btn-lg btn-secondary btn-block border-0" type="submit">Submit
                                Now</button>
                        </div>
                    </form>
                </div>
        ...
        <div class="container-fluid bg-dark px-sm-3 px-md-5 py-4 text-white">
            <p class="m-0 text-center text-white">
                &copy; <a class="font-weight-medium text-white" href="#">Your Site Name</a>. All Rights
                Reserved.

                <!--/*** This template is free as long as you keep the footer author’s credit link/attribution link/backlink. If you'd like to use the template without the footer author’s credit link/attribution link/backlink, you can purchase the Credit Removal License from "https://htmlcodex.com/credit-removal". Thank you for your support. ***/-->
                Designed by <a class="font-weight-medium text-white" href="https://htmlcodex.com">HTML Codex</a>
            </p>
        </div>
        <!-- Footer End -->
